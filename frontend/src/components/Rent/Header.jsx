      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="m-2 p-2 w-40 bg-[#5e1e30] text-white shadow-xl rounded-lg  ">
            <DropdownMenuLabel className="text-lg font-semibold text-gray-300">Navigation</DropdownMenuLabel>
            <DropdownMenuSeparator className="border-gray-700" />
            <DropdownMenuGroup>
              <DropdownMenuItem asChild>
                <Link to="/" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-[#321d21]">
                  <Home size={20} /> <span>Home</span>
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link to="/provider" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-800">
                  <Server size={20} /> <span>Provider</span>
                </Link>
              </DropdownMenuItem>
              <DropdownMenuItem asChild>
                <Link to="/about" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-800">
            ...
            <DropdownMenuSeparator className="border-gray-700" />
            <DropdownMenuItem asChild>
              <Link to="/logout" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-red-700">
        ...
        {/* Logo */}
        <h1 className="text-[#d49c79] text-2xl font-extrabold tracking-wide">DecnAIX</h1>
      </div>
